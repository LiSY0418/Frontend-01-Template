...
function layout(element) {
    ...
    if (mainSpace < 0) {
        ...
        flexLines.forEach(function(items) {
            ...
            if (flexTotal > 0) {
                ...
                // There is *NO* flexible f;ex items, which means, justifyContent shoud work
    ...
    flexLines.forEach(function(items) {
        ...
        for (var i = 0; i < items.length; i++) {
            ...
            if (align === 'stretch') {
                itemStyle[crossStart] = crossBase;
                itemStyle[crossEnd] = crossBase + crossSign * ((itemStyle[crossSize] !== nill && itemStyle[crossSize] !== (void 0)) ? itemStyle[crossSize] : lineCrossSize);
